...
//         NNDescent(const std::size_t K, const std::vector<data_type> &datas, const double rho = 0.5, const double perturb_rate = 0, const std::size_t num_random_join = 10, const rand_type &rand = rand_type(0), const sim_type &sim = sim_type())
